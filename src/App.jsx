  ...
  useEffect(() => {
    ...
    voteModule.getAll()
      .then((proposals) => {
        ...
        console.log("Unable to retrieve proposals", err);
      });
  }, [hasClaimedNFT]);
  ...
  useEffect(() => {
    ...
    voteModule.
      ...
      .then((hasVoted) => {
        ...
        console.log("Failed to check if user voted", err);
      });
  ...
  useEffect(() => {
    ...
    tokenModule.getAllHolderBalances()
      .then((amount) => {
        ...
        console.log("Failed to get amounts", err);
    })
  }, [hasClaimedNFT]);
  ...
  useEffect(() => {
    ...
    .then((balance) => {
      if (balance.gt(0)) {
        ...
        console.log(`Successfully minted! checkout opensea https://testnets.opensea.io/assets/${ bundleDropModule.address }/0`);
        console.log("User has NFT membership");
      } else {
        setHasClaimedNFT(false);
        console.log("User doesnt have NFT membership")
      }
    }).catch((error) => {
      setHasClaimedNFT(false);
